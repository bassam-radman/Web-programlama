...
namespace WebHomework.Controllers
{
   // [Authorize(Roles = "Admin")]
    public class GymServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Duration,Price")] GymService gymService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Duration,Price")] GymService gymService)
        {
            if (id != gymService.Id)
            {
                return NotFound();
